...
// "Report this listing" for real estate — same shape as the marketplace one,
// with property-specific reasons.
export function ReportEstateButton({
  locale,
  dict,
  listingId,
  loggedIn,
  ...
  const [state, action, pending] = useActionState(reportPropertyListing, undefined);
